...
<div class="be-wrapper">
    ...
    <div class="be-content">
        <div class="page-head">
            <h2 class="page-head-title">All Type</h2>
                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        <div style="border: solid 1px blue; text-align: center; size: 25px; height: 25px">
                            <a style="text-align: center; font-size: 20px" href="/noteTypes?action=create">Add New
                                Note Type</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped table-hover table-fw-widget" id="table6">
                                ...
                                <c:forEach var="noteType" items="${listNoteType}">
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="/notes?action=delete&id=${noteType.id}">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
